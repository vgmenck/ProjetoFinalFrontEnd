# Projeto-Front-End  
Projeto da disciplina **EC47C – Programação Web Front-End**
...
- Estilização via CSS (e possivelmente pré-processadores ou frameworks, se aplicável);  
- Interação e comportamento via JavaScript (validação de formulários, navegação, responsividade etc.);  
- Organização de arquivos e pastas para facilitar manutenção e escalabilidade.

---

## 🗂 Estrutura do Projeto  
A estrutura de pastas e arquivos do repositório segue este padrão:
